...
<article class="container-fluid pb-5 mb-5">
    <main class="mt-5 pt-3">
        <div class="border border-dark" style="margin-top: 25px; margin-left: 15%; margin-right: 15%;">
            <p><b>Selamat Datang nama user di Aplikasi Peduli Diri</b></p>
            <br>
            <br>
            <br>
            <br>
        ...
        <br>
        <a href="isi_data.php" class="btn btn-primary" style="margin-left: 970px; margin-top: 15px;">Isi Data Perjalanan</a>
    </main>
</article>
